        ...
        <>
            <div id="menu-main-container">
                ...
                <div className="menu-right-container">
                    ...
                    <div className="menu-left-center-info">
                        <div className="menu-online-offline-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 303 172" width="360"
                                preserveAspectRatio="xMidYMid meet" className="" fill="none">
                                ...
                                <rect x="0.445307" y="0.549558" width="50.4027" height="99.7216" rx="7.5"
                                    transform="matrix(0.994522 0.104528 -0.103907 0.994587 10.9258 37.9564)" fill="#EEFAF6"
                                    stroke="#316474" />
                                <path
                    ...
                    <div className="menu-encrypted-info">
                        <div className="menu-encrypted-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 12" height="12"
                            width="10" preserveAspectRatio="xMidYMid meet" className="" version="1.1">
                            <path
                        ...
                        <div>
                            <p className="menu-encrypted-info-para">End-to-end-encrypted</p>
                        </div>
